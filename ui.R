...
shinyUI(navbarPage(HTML(paste0('<a href=',shQuote(saved_url), '>', '<img height="25px" src="data:image/png;base64,"></a>', ' <a href=',shQuote(saved_url), '>OwnYourData', '</a>')), 
                   id="page", collapsible=TRUE, inverse=FALSE, windowTitle='Allergie-Tagebuch | OwnYourData', 
                   tabPanel('Allergie-Tagebuch',
                            bsAlert("topAlert"),
                            sidebarLayout(
                sidebarPanel(
...
navbarMenu('Infos',
           tabPanel(HTML("Version</a></li><li><a href=\"https://github.com/OwnYourData/app-allergy/blob/master/README.md\">Anleitung"),
                    sidebarLayout(
                            sidebarPanel(
                                    p('Support: ', 
                                    ...
                                    p('Bugtracking: ',
                                      a(href="https://github.com/OwnYourData/app-allergy/issues",
                                        "Github")),
                                    hr(),
                                    p('entwickelt von ',
